// This is the multiplayer screen to select a game
...
import 'multiplayer_wait_screen.dart';

class MultiPlayerSelectScreen extends StatefulWidget {
  final User user;
  final List<Game> games;

  const MultiPlayerSelectScreen({Key? key, required this.user, required this.games})
      : super(key: key);

  @override
  State<MultiPlayerSelectScreen> createState() => _MultiPlayerSelectScreen();
}

class _MultiPlayerSelectScreen extends State<MultiPlayerSelectScreen>
